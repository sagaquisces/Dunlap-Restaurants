...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void createNewUser() {
        mName = mRegNameEditText.getText().toString().trim();
    ...
    private boolean isValidEmail(String email) {
        ...
        if (!isGoodEmail) {
            mRegEmailEditText.setError("Please enter a valid email address");
            return false;
        }
        return isGoodEmail;
    }
    ...
    private boolean isValidName(String name) {
        if (name.equals("")) {
            mRegNameEditText.setError("Please enter your name");
            return false;
        }
        return true;
    }
    ...
    private boolean isValidPassword(String password, String confirmPassword) {
        if (password.length() < 6) {
            mRegPasswordEditText.setError("Please create a password containing at least 6 characters");
            return false;
        } else if (!password.equals(confirmPassword)) {
            mRegPasswordEditText.setError("Passwords do not match");
            return false;
        }
        return true;
    }
